package com.flink.realtim.app.dwd;
...
//        env.setStateBackend(new FsStateBackend("hdfs://172.24.240.137:8020/gmall/checkpoint/baselogApp"));
        ...
        Map<KafkaTopicPartition, Long> partitionLongMap = new HashMap<>();
        partitionLongMap.put(new KafkaTopicPartition(topic, 0), 0L);
//        kafkaSource.setStartFromSpecificOffsets(partitionLongMap);
